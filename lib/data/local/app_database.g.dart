...
class $AccountsTable extends Accounts with TableInfo<$AccountsTable, Account> {
  ...
  late final GeneratedColumn<String> colorHex = GeneratedColumn<String>(
    ...
    type: DriftSqlType.string,
    requiredDuringInsert: false,
    defaultValue: const Constant('#881337'),
  );
...
class Category extends DataClass implements Insertable<Category> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, name, kind, iconKey, colorHex, isDefault, sortOrder);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Category &&
...
class Budget extends DataClass implements Insertable<Budget> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, year, month, categoryId, limitCents, currency);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Budget &&
...
class $InvestmentsTable extends Investments
  ...
  static const VerificationMeta _initialAmountCentsMeta =
      const VerificationMeta('initialAmountCents');
  @override
  late final GeneratedColumn<int> initialAmountCents = GeneratedColumn<int>(
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('initial_amount_cents')) {
      context.handle(
        _initialAmountCentsMeta,
        initialAmountCents.isAcceptableOrUnknown(
          data['initial_amount_cents']!,
          _initialAmountCentsMeta,
        ),
      );
    } else if (isInserting) {
      context.missing(_initialAmountCentsMeta);
    }
  ...
  Investment map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Investment(
      ...
      initialAmountCents: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}initial_amount_cents'],
      )!,
...
class Investment extends DataClass implements Insertable<Investment> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['name'] = Variable<String>(name);
    map['type'] = Variable<String>(type);
    map['initial_amount_cents'] = Variable<int>(initialAmountCents);
  ...
  factory Investment.fromJson(
    ...
    return Investment(
      ...
      name: serializer.fromJson<String>(json['name']),
      type: serializer.fromJson<String>(json['type']),
      initialAmountCents: serializer.fromJson<int>(json['initialAmountCents']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'name': serializer.toJson<String>(name),
      'type': serializer.toJson<String>(type),
      'initialAmountCents': serializer.toJson<int>(initialAmountCents),
  ...
  Investment copyWithCompanion(InvestmentsCompanion data) {
    return Investment(
      ...
      name: data.name.present ? data.name.value : this.name,
      type: data.type.present ? data.type.value : this.type,
      initialAmountCents: data.initialAmountCents.present
          ? data.initialAmountCents.value
  ...
  String toString() {
    return (StringBuffer('Investment(')
          ...
          ..write('name: $name, ')
          ..write('type: $type, ')
          ..write('initialAmountCents: $initialAmountCents, ')
  ...
  bool operator ==(Object other) =>
      ...
      (other is Investment &&
          ...
          other.name == this.name &&
          other.type == this.type &&
          other.initialAmountCents == this.initialAmountCents &&
...
class InvestmentsCompanion extends UpdateCompanion<Investment> {
  ...
  final Value<String> name;
  final Value<String> type;
  final Value<int> initialAmountCents;
  ...
  const InvestmentsCompanion({
    ...
    this.name = const Value.absent(),
    this.type = const Value.absent(),
    this.initialAmountCents = const Value.absent(),
  ...
  static Insertable<Investment> custom({
    ...
    Expression<String>? name,
    Expression<String>? type,
    Expression<int>? initialAmountCents,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (initialAmountCents.present) {
      map['initial_amount_cents'] = Variable<int>(initialAmountCents.value);
    }
...
class $SavingsGoalsTable extends SavingsGoals
  ...
  static const VerificationMeta _deadlineMsMeta = const VerificationMeta(
    'deadlineMs',
  );
  @override
  late final GeneratedColumn<int> deadlineMs = GeneratedColumn<int>(
    'deadline_ms',
    aliasedName,
    true,
    type: DriftSqlType.int,
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('deadline_ms')) {
      context.handle(
        _deadlineMsMeta,
        deadlineMs.isAcceptableOrUnknown(data['deadline_ms']!, _deadlineMsMeta),
      );
    }
    if (data.containsKey('created_at')) {
      context.handle(
  ...
  SavingsGoal map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return SavingsGoal(
      ...
      deadlineMs: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}deadline_ms'],
      ),
      createdAt: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}created_at'],
...
class SavingsGoal extends DataClass implements Insertable<SavingsGoal> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || deadlineMs != null) {
      map['deadline_ms'] = Variable<int>(deadlineMs);
    }
    map['created_at'] = Variable<int>(createdAt);
    return map;
  }
  ...
  SavingsGoalsCompanion toCompanion(bool nullToAbsent) {
    return SavingsGoalsCompanion(
      ...
      currency: Value(currency),
      emoji: Value(emoji),
      deadlineMs: deadlineMs == null && nullToAbsent
          ? const Value.absent()
          : Value(deadlineMs),
      createdAt: Value(createdAt),
    );
  ...
  factory SavingsGoal.fromJson(
    ...
    return SavingsGoal(
      ...
      deadlineMs: serializer.fromJson<int?>(json['deadlineMs']),
      createdAt: serializer.fromJson<int>(json['createdAt']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'deadlineMs': serializer.toJson<int?>(deadlineMs),
      'createdAt': serializer.toJson<int>(createdAt),
    };
  }
  ...
  SavingsGoal copyWith({
    ...
    String? currency,
    String? emoji,
    Value<int?> deadlineMs = const Value.absent(),
    int? createdAt,
  }) => SavingsGoal(
    id: id ?? this.id,
    name: name ?? this.name,
    ...
    deadlineMs: deadlineMs.present ? deadlineMs.value : this.deadlineMs,
    createdAt: createdAt ?? this.createdAt,
  );
  SavingsGoal copyWithCompanion(SavingsGoalsCompanion data) {
    return SavingsGoal(
      ...
      deadlineMs: data.deadlineMs.present
          ? data.deadlineMs.value
          : this.deadlineMs,
      createdAt: data.createdAt.present ? data.createdAt.value : this.createdAt,
    );
  }
  ...
  bool operator ==(Object other) =>
      ...
      (other is SavingsGoal &&
          ...
          other.deadlineMs == this.deadlineMs &&
          other.createdAt == this.createdAt);
}
...
class SavingsGoalsCompanion extends UpdateCompanion<SavingsGoal> {
  ...
  const SavingsGoalsCompanion({
    ...
    this.deadlineMs = const Value.absent(),
    this.createdAt = const Value.absent(),
    this.rowid = const Value.absent(),
  });
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (deadlineMs.present) {
      map['deadline_ms'] = Variable<int>(deadlineMs.value);
    }
    if (createdAt.present) {
      map['created_at'] = Variable<int>(createdAt.value);
    }
...
class $RecurringTransactionsTable extends RecurringTransactions
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('next_due_date_ms')) {
      ...
      context.missing(_nextDueDateMsMeta);
    }
    if (data.containsKey('note')) {
      context.handle(
        _noteMeta,
...
class RecurringTransaction extends DataClass
  ...
  RecurringTransactionsCompanion toCompanion(bool nullToAbsent) {
    return RecurringTransactionsCompanion(
      ...
      nextDueDateMs: Value(nextDueDateMs),
      note: note == null && nullToAbsent ? const Value.absent() : Value(note),
      active: Value(active),
      createdAt: Value(createdAt),
    );
...
class $$InvestmentsTableFilterComposer
  ...
  ColumnFilters<int> get initialAmountCents => $composableBuilder(
    column: $table.initialAmountCents,
    builder: (column) => ColumnFilters(column),
  );
...
class $$InvestmentsTableOrderingComposer
  ...
  ColumnOrderings<int> get initialAmountCents => $composableBuilder(
    column: $table.initialAmountCents,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$InvestmentsTableAnnotationComposer
  ...
  GeneratedColumn<int> get initialAmountCents => $composableBuilder(
    column: $table.initialAmountCents,
    builder: (column) => column,
  );
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<String> name = const Value.absent(),
                Value<String> type = const Value.absent(),
                Value<int> initialAmountCents = const Value.absent(),
...
class $$SavingsGoalsTableFilterComposer
  ...
  ColumnFilters<int> get deadlineMs => $composableBuilder(
    column: $table.deadlineMs,
    builder: (column) => ColumnFilters(column),
  );
...
class $$SavingsGoalsTableOrderingComposer
  ...
  ColumnOrderings<int> get deadlineMs => $composableBuilder(
    column: $table.deadlineMs,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$SavingsGoalsTableAnnotationComposer
  ...
  GeneratedColumn<int> get deadlineMs => $composableBuilder(
    column: $table.deadlineMs,
    builder: (column) => column,
  );
